#Core module, manages everything
import pygame
import os
import platform
...
class GameCore():
    def __init__(self):
        ...
        pygame.display.set_caption("TD") #Sets caption

        interval = 50 #Interval of logic cycles in miliseconds (1/1000 of the second)
