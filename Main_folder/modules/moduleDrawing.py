"""Module containing some advanced drawing functions."""
import pygame
...
def create_terrain_surface(terrain,terrain_encoding,name_to_image_dict,TILE_SIZE):
    ...
    terrain must be 2-dimensional iterable containing characters representing terrain
    tiles. terrain_encoding must be dictionary containing terrain character:tile name
    pairs. name_to_image_dict must be dictionary containing object/tile name:surface
    pairs. TILE_SIZE is integer constant indicating length of tile side.
    """
